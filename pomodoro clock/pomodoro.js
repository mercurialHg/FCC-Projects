    ...
    $.extend(Pomodoro.prototype, {
        start: function () {
            ...
            var _ = this,
                ...
                currentSession, currentSessionTime, currentSession, repTime;
            //if stopped
            ...
            settings.unit = _.setUnit(settings[currentSession]);
            ...
            function timer() {
                ...
                console.log('start: session reptime ', currentSessionTime, repTime, currentSession);
                ...
                if (currentSessionTime === -1) {
                    currentSession = settings.currentSession = currentSession === 'work' ? 'pause' : 'work';
